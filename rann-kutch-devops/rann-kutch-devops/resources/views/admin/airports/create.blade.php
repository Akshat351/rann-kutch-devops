...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.airport.title_singular') }}
    </div>
    ...
    @endif
    <span class="help-block">{{ trans('cruds.airport.fields.distance_helper') }}</span>
</div>
            <div class="form-group">
    ...
    <input class="form-control {{ $errors->has('mini') ? 'is-invalid' : '' }}" 
           ...
           value="{{ old('mini', '') }}">
    @if($errors->has('mini'))
        <div class="invalid-feedback">{{ $errors->first('mini') }}</div>
    @endif
...
<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('sedan') ? 'is-invalid' : '' }}" 
           ...
           value="{{ old('sedan', '') }}">
    @if($errors->has('sedan'))
        <div class="invalid-feedback">{{ $errors->first('sedan') }}</div>
    @endif
...
<div class="form-group">
    ...
    <input class="form-control {{ $errors->has('suv') ? 'is-invalid' : '' }}" 
           ...
           value="{{ old('suv', '') }}">
    @if($errors->has('suv'))
        <div class="invalid-feedback">{{ $errors->first('suv') }}</div>
    @endif
...
<div class="form-group">
    ...
    @if($errors->has('innova'))
        <div class="invalid-feedback">{{ $errors->first('innova') }}</div>
    @endif
