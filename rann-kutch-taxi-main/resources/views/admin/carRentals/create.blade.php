...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.carRental.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.car-rentals.store") }}" enctype="multipart/form-data">
            @csrf
                ...
                <select class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" name="name" id="name" required>
                    <option value="" disabled {{ old('name') ? '' : 'selected' }}>-- Select Car Type --</option>
                 {{--    <option value="Mini" {{ old('name') == 'Mini' ? 'selected' : '' }}>Mini</option> --}}
                    <option value="Sedan" {{ old('name') == 'Sedan' ? 'selected' : '' }}>Sedan</option>
                    <option value="SUV" {{ old('name') == 'SUV' ? 'selected' : '' }}>SUV</option>
                    <option value="Innova" {{ old('name') == 'Innova' ? 'selected' : '' }}>Innova</option>
                </select>
                @if($errors->has('name'))
