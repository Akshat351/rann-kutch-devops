...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.priceperkm.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.priceperkm.store") }}" enctype="multipart/form-data">
            @csrf
            {{-- <div class="form-group">
                <label class="required" for="mini_price_per_km">{{ trans('cruds.priceperkm.fields.mini_price_per_km') }}</label>
                <input class="form-control {{ $errors->has('mini_price_per_km') ? 'is-invalid' : '' }}" type="text" name="mini_price_per_km" id="mini_price_per_km" value="{{ old('mini_price_per_km', '') }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sedan_price_per_km') ? 'is-invalid' : '' }}" type="text" name="sedan_price_per_km" id="sedan_price_per_km" value="{{ old('sedan_price_per_km', '') }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('suv_price_per_km') ? 'is-invalid' : '' }}" type="text" name="suv_price_per_km" id="suv_price_per_km" value="{{ old('suv_price_per_km', '') }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('innova_price_per_km') ? 'is-invalid' : '' }}" type="text" name="innova_price_per_km" id="innova_price_per_km" value="{{ old('innova_price_per_km', '') }}" >
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('driver_allowance_per_day') ? 'is-invalid' : '' }}" type="text" name="driver_allowance_per_day" id="driver_allowance_per_day" value="{{ old('driver_allowance_per_day', '') }}" >
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mini_km_per_day') ? 'is-invalid' : '' }}" type="text" name="mini_km_per_day" id="mini_km_per_day" value="{{ old('mini_km_per_day', '') }}" >
