...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.localCab.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.local-cabs.update', [$localCab->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name"
                        id="name" value="{{ old('name', $localCab->name) }}" required>
                    @if ($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug"
                        id="slug" value="{{ old('slug', $localCab->slug) }}" required>
                    @if ($errors->has('slug'))
                        <div class="invalid-feedback">
                            {{ $errors->first('slug') }}
                        </div>
                ...
                <h4 class="mt-4 mb-2">Mini Rates</h4>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="number" step="0.01" name="mini_eight_hr_eighty_km"
                            value="{{ old('mini_eight_hr_eighty_km', $localCab->mini_eight_hr_eighty_km) }}">
                    </div>
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="number" step="0.01" name="mini_ten_hr_hundred_km"
                            value="{{ old('mini_ten_hr_hundred_km', $localCab->mini_ten_hr_hundred_km) }}">
                    </div>
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="number" step="0.01" name="mini_twelve_hr_hundred_twenty_km"
                            value="{{ old('mini_twelve_hr_hundred_twenty_km', $localCab->mini_twelve_hr_hundred_twenty_km) }}">
                    </div>
                </div>

                <h4 class="mt-4 mb-2">Sedan Rates</h4>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="number" step="0.01" name="sedan_eight_hr_eighty_km"
                            value="{{ old('sedan_eight_hr_eighty_km', $localCab->sedan_eight_hr_eighty_km) }}">
                    </div>
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="number" step="0.01" name="sedan_ten_hr_hundred_km"
                            value="{{ old('sedan_ten_hr_hundred_km', $localCab->sedan_ten_hr_hundred_km) }}">
                    </div>
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="number" step="0.01" name="sedan_twelve_hr_hundred_twenty_km"
                            value="{{ old('sedan_twelve_hr_hundred_twenty_km', $localCab->sedan_twelve_hr_hundred_twenty_km) }}">
                    </div>
                </div>



                <h4 class="mt-4 mb-2">Ertiga Rates</h4>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="number" step="0.01" name="ertiga_eight_hr_eighty_km"
                            value="{{ old('ertiga_eight_hr_eighty_km', $localCab->ertiga_eight_hr_eighty_km) }}">
                    </div>
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="number" step="0.01" name="ertiga_ten_hr_hundred_km"
                            value="{{ old('ertiga_ten_hr_hundred_km', $localCab->ertiga_ten_hr_hundred_km) }}">
                    </div>
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="number" step="0.01" name="ertiga_twelve_hr_hundred_twenty_km"
                            value="{{ old('ertiga_twelve_hr_hundred_twenty_km', $localCab->ertiga_twelve_hr_hundred_twenty_km) }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('sort_description') ? 'is-invalid' : '' }}" name="sort_description"
                        id="sort_description">{{ old('sort_description', $localCab->sort_description) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description"
                        id="description">{!! old('description', $localCab->description) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text"
                        name="meta_title" id="meta_title" value="{{ old('meta_title', $localCab->meta_title) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" name="meta_description"
                        id="meta_description">{{ old('meta_description', $localCab->meta_description) }}</textarea>
