                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('trip_type') ? 'is-invalid' : '' }}" name="trip_type"
                        ...
                        @foreach (App\Models\Trip::TRIP_TYPE_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('trip_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                            </option>
                        @endforeach
                    </select>
              ...
              {{--   <div class="form-group">
                    <div class="form-check">
                        ...
                        <span class="help-block">
                            {{ trans('cruds.trip.fields.is_airport_helper') ?? 'Check this if this trip is for airport routes.' }}
                        </span>
                    </div>
                </div> --}}
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mini') ? 'is-invalid' : '' }}" type="number"
                        name="mini" id="mini" value="{{ old('mini', '') }}" step="0.01">
                    @if ($errors->has('mini'))
                        <div class="invalid-feedback">
                            {{ $errors->first('mini') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('sedan') ? 'is-invalid' : '' }}" type="number"
                        name="sedan" id="sedan" value="{{ old('sedan', '') }}" step="0.01">
                    @if ($errors->has('sedan'))
                        <div class="invalid-feedback">
                            {{ $errors->first('sedan') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('ertiga') ? 'is-invalid' : '' }}" type="number" name="ertiga"
                        id="ertiga" value="{{ old('ertiga', '') }}" step="0.01">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('innova') ? 'is-invalid' : '' }}" type="number"
                        name="innova" id="innova" value="{{ old('innova', '') }}" step="0.01">
